...
namespace DrumBot
{
    class ImageProcessing
    {
        ...
        public void ProcessImage(Image<Bgr,Byte> screenshot,out Image<Bgr,byte> redTrack,out Image<Bgr,byte> yellowTrack,out Image<Bgr,byte> blueTrack,out Image<Bgr,byte> greenTrack)
        {
        ...
        public Image<Bgr, byte> ExtractRedTrack(Image<Bgr, byte> playArea)
        {
        ...
        public Image<Bgr, byte> ExtractBlueTrack(Image<Bgr, byte> playArea)
        {
        ...
        public Image<Bgr, byte> ExtractYellowTrack(Image<Bgr, byte> playArea)
        {
